...
import { Calendar, ArrowRight, Sparkles, Workflow, BrainCircuit, Quote, Star, ArrowUpRight, Zap, Database, Terminal } from "lucide-react";
...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Transform your business operations with precision technology — ERP consulting, AI, and custom software from RAPTRON Digital Solutions LLC." },
    ],
  }),
  component: HomePage,
});
      ...
      <div className="relative z-20 w-full max-w-7xl px-6 lg:px-10 text-center flex flex-col items-center">
        <Reveal>
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/70 backdrop-blur-md border border-hairline shadow-sm mb-8">
            ...
            <span className="text-xs font-mono uppercase tracking-[0.2em] text-ink font-semibold">The Future of Enterprise Tech</span>
          </div>
          
          <h1 className="font-display font-bold text-5xl sm:text-6xl lg:text-[5.5rem] leading-[1.05] text-ink max-w-5xl mx-auto">
            Architecting <span className="text-brand">Intelligent</span> <br className="hidden sm:block" /> Business Systems.
          </h1>
          
          <p className="mt-6 text-xl sm:text-2xl text-ink/70 max-w-3xl mx-auto leading-relaxed">
            We merge ERP consulting, AI automation, and custom software to build the operational backbone of tomorrow's industry leaders.
          </p>
          
          <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/book-consultation" className="inline-flex items-center justify-center gap-2 h-14 px-8 rounded-full bg-gradient-brand text-white font-semibold text-lg shadow-card hover:shadow-glow transition-all hover:scale-105">
              <Calendar size={20} /> Book Free Consultation
            </Link>
            <Link to="/request-demo" className="inline-flex items-center justify-center gap-2 h-14 px-8 rounded-full border border-hairline text-ink font-semibold text-lg hover:border-brand/40 hover:bg-surface-tinted transition-colors">
          ...
          <div className="mt-20 w-full max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-4 p-4 rounded-[2rem] bg-white/40 backdrop-blur-2xl border border-white/60 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] text-left">
            <div className="col-span-1 md:col-span-2 bg-ink rounded-2xl p-8 lg:p-10 relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-white font-display text-3xl font-bold mb-3">ERP Architecture</h3>
                <p className="text-white/60 text-base max-w-sm">Orchestrating complex enterprise resource planning deployments with zero downtime and total strategic alignment.</p>
              </div>
            </div>
            <div className="col-span-1 bg-gradient-brand rounded-2xl p-8 lg:p-10 relative overflow-hidden group">
               ...
               <div className="relative z-10">
                 ...
                 <p className="text-white/80 text-base">Deploying autonomous intelligence into your core operational workflows.</p>
               </div>
            </div>
          </div>
        </Reveal>
  ...
  return (
    <div className="w-full border-b border-hairline bg-white py-8 overflow-hidden flex items-center relative z-20">
       ...
       <div className="absolute left-0 top-0 bottom-0 z-20 flex items-center bg-white pl-6 lg:pl-10 pr-6">
         <div className="font-mono text-[10px] uppercase tracking-[0.2em] text-ink/40">Trusted Across Sectors</div>
       ...
       <div className="animate-marquee flex gap-16 px-6 whitespace-nowrap">
         {[...INDUSTRIES, ...INDUSTRIES, ...INDUSTRIES].map(({ name, icon: Icon }, i) => (
           <div key={`${name}-${i}`} className="flex items-center gap-3 text-ink/60 font-semibold text-lg hover:text-brand transition-colors cursor-default">
  ...
  return (
    <section className="py-12 bg-mist border-b border-hairline relative z-20">
      <div className="max-w-7xl mx-auto px-6 lg:px-10 flex flex-col md:flex-row items-center justify-between gap-8">
        <h3 className="font-mono text-sm uppercase tracking-[0.2em] text-ink/40 font-semibold whitespace-nowrap">Core Technologies</h3>
        <div className="flex flex-wrap items-center justify-center md:justify-end gap-10 lg:gap-16 grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition-all duration-500 cursor-default">
          {/* Odoo */}
          <div className="text-4xl font-display font-bold tracking-tighter text-[#714B67] select-none">odoo</div>
          {/* SAP */}
          <div className="text-4xl font-display font-extrabold tracking-wide text-[#008FD3] select-none italic">SAP</div>
          {/* ZOHO */}
          <div className="flex items-center gap-1 select-none shadow-sm">
            <div className="size-8 rounded-sm bg-[#E42528] flex items-center justify-center text-white font-bold text-xl">Z</div>
            <div className="size-8 rounded-sm bg-[#41B649] flex items-center justify-center text-white font-bold text-xl">O</div>
            <div className="size-8 rounded-sm bg-[#F89C1E] flex items-center justify-center text-white font-bold text-xl">H</div>
            <div className="size-8 rounded-sm bg-[#00A1E0] flex items-center justify-center text-white font-bold text-xl">O</div>
          </div>
          {/* ERP Next */}
          <div className="text-4xl font-display font-bold text-[#006aff] select-none tracking-tight">ERP<span className="font-light">Next</span></div>
        </div>
      </div>
    </section>
  );
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <Reveal>
          <div className="text-center mb-20">
            <h2 className="font-display font-extrabold text-5xl sm:text-6xl tracking-tight text-ink">Beyond Implementation.</h2>
          ...
          <div className="grid md:grid-cols-3 gap-6 auto-rows-[320px]">
            ...
            <div className="md:col-span-2 rounded-[2rem] border border-hairline bg-surface-tinted p-12 relative overflow-hidden group hover:shadow-card transition-all duration-500 hover:-translate-y-1">
              ...
              <div className="relative z-10">
                ...
                <p className="mt-4 text-ink/65 max-w-md text-lg leading-relaxed">We don't just migrate data; we structure it to feed predictive AI models, automate reporting, and power real-time executive dashboards.</p>
              </div>
            </div>
            {/* Box 2 */}
            <div className="md:col-span-1 rounded-[2rem] border border-hairline bg-ink p-12 relative overflow-hidden group hover:shadow-glow transition-all duration-500 hover:-translate-y-1">
               ...
               <div className="relative z-10">
                 ...
                 <p className="mt-4 text-white/60 text-lg leading-relaxed">Shipping custom modules 4x faster with our proprietary enterprise frameworks.</p>
               </div>
            </div>
            {/* Box 3 */}
            <div className="md:col-span-1 rounded-[2rem] border border-hairline bg-gradient-brand p-12 text-white hover:scale-[1.02] transition-transform duration-500 group">
              <Terminal className="mb-8 opacity-80 group-hover:opacity-100 transition-opacity" size={40} />
              <h3 className="font-display text-3xl font-bold">Code Quality</h3>
              <p className="mt-4 text-white/90 text-lg leading-relaxed">Enterprise-grade architecture built to scale securely and continuously.</p>
            </div>
            {/* Box 4 */}
            <div className="md:col-span-2 rounded-[2rem] border border-hairline bg-white shadow-sm p-12 relative overflow-hidden group hover:shadow-card transition-all duration-500 hover:-translate-y-1">
              <div className="flex flex-col justify-center h-full max-w-xl relative z-10">
                ...
                <p className="mt-4 text-ink/65 text-lg leading-relaxed">From initial process audit to post-go-live optimization. One accountable team, zero handoffs, absolute transparency.</p>
              </div>
        ...
        <Reveal>
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-5">
              <div className="font-mono text-sm uppercase tracking-widest text-brand-2 mb-6">Core Disciplines</div>
              ...
              <div className="space-y-2">
                {SERVICES.map((s, i) => (
                  ...
                  >
                    <h3 className={`font-display text-2xl font-bold transition-colors ${activeIdx === i ? 'text-white' : 'text-white/40 group-hover:text-white/70'}`}>
                      {s.title}
                    </h3>
                    <div className={`overflow-hidden transition-all duration-500 ease-in-out ${activeIdx === i ? 'max-h-40 opacity-100 mt-4' : 'max-h-0 opacity-0'}`}>
                      <p className="text-white/60 mb-5 leading-relaxed">{s.tagline}</p>
                      <Link to="/services/$slug" params={{ slug: s.slug }} className="inline-flex items-center gap-2 text-brand-2 text-sm font-semibold hover:text-white transition-colors">
                  ...
                  return (
                    ...
                    >
                      <div className="size-40 rounded-full bg-brand/20 flex items-center justify-center mb-10 border border-brand/30 shadow-[0_0_80px_rgba(85,9,217,0.5)] backdrop-blur-md">
                        <Icon size={72} className="text-brand-2 drop-shadow-[0_0_15px_rgba(163,54,255,0.8)]" />
                      </div>
                      <h4 className="font-display text-4xl font-bold text-white mb-6 tracking-tight">{s.shortTitle}</h4>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 relative z-10">
        <Reveal>
          <div className="text-center mb-28">
            <h2 className="font-display font-extrabold text-5xl lg:text-6xl text-ink">Engineering Success</h2>
            <p className="mt-6 text-xl text-ink/60">A deterministic methodology for digital transformation.</p>
          </div>
            ...
            <div className="grid md:grid-cols-5 gap-10 md:gap-4 relative z-10">
              {PROCESS_STEPS.map((step, i) => (
                <div key={step.title} className="relative group flex flex-col md:items-center">
                  ...
                  {/* Content Card */}
                  <div className={`mt-8 md:mt-0 md:pt-12 transition-all duration-500 md:group-hover:-translate-y-2 w-full ${i % 2 !== 0 ? 'md:pt-32' : ''}`}>
                    <div className="bg-white p-8 rounded-3xl shadow-sm border border-hairline group-hover:shadow-card transition-all relative overflow-hidden text-left md:text-center h-full">
                      <div className="font-mono text-5xl font-bold text-ink/5 absolute -top-2 -right-2 group-hover:text-brand/10 transition-colors pointer-events-none select-none">0{i+1}</div>
                      <h4 className="font-display font-bold text-2xl mb-3 text-ink relative z-10">{step.title}</h4>
                      <p className="text-base text-ink/65 relative z-10 leading-relaxed">{step.description}</p>
                    </div>
                  </div>
                </div>
              ))}
       ...
       <div className="max-w-7xl mx-auto px-6 lg:px-10 relative z-10">
         <Reveal>
           <div className="grid grid-cols-2 md:grid-cols-4 gap-12 lg:gap-8 divide-x-0 md:divide-x divide-white/10 text-center md:text-left">
             {STATS.map((s, i) => (
               <div key={s.label} className="md:pl-8 first:pl-0 flex flex-col items-center md:items-start">
  ...
  return (
    <section className="py-32 bg-white overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 text-center mb-20">
         <Reveal>
           <div className="font-mono text-sm uppercase tracking-widest text-brand mb-4">Client Voices</div>
           <h2 className="font-display font-extrabold text-5xl lg:text-6xl text-ink">Trusted by Visionaries</h2>
         </Reveal>
      </div>
      ...
      <div className="relative w-full flex overflow-x-hidden">
        ...
        <div className="animate-marquee flex gap-8 px-4 whitespace-nowrap py-4">
          {[...TESTIMONIALS, ...TESTIMONIALS].map((t, i) => (
            <div key={`${t.name}-${i}`} className="w-[450px] shrink-0 whitespace-normal rounded-[2rem] bg-surface-tinted p-10 border border-hairline hover:border-brand/40 transition-colors hover:shadow-card group">
              <div className="flex gap-1.5 text-brand mb-8 opacity-80 group-hover:opacity-100 transition-opacity">
                {Array.from({ length: 5 }).map((_, k) => <Star key={k} size={20} fill="currentColor" />)}
              </div>
              ...
              <div className="flex items-center gap-5">
                ...
                <div>
                  ...
                  <div className="text-base text-ink/60 mt-1">{t.title}, {t.company}</div>
                </div>
              </div>
            </div>
          ))}
