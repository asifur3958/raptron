...
import { Sparkles, ShieldCheck, TrendingUp, Handshake, Target, Zap, Award, Globe, Database, BrainCircuit, Workflow, Users, Crosshair, ArrowRight } from "lucide-react";
...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "RAPTRON Digital Solutions LLC — built for the businesses that power the world." },
    ],
  }),
  component: AboutPage,
});
      ...
      <div className="relative z-20 w-full max-w-7xl px-6 lg:px-10 flex flex-col lg:flex-row items-center gap-16">
        <Reveal className="lg:w-1/2">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/70 backdrop-blur-md border border-hairline shadow-sm mb-8">
            ...
            <span className="text-xs font-mono uppercase tracking-[0.2em] text-ink font-semibold">About Raptron</span>
          </div>
          
          <h1 className="font-display font-extrabold text-5xl sm:text-6xl lg:text-7xl leading-[1.05] tracking-tight text-ink">
            Built for the <br />
            <span className="text-transparent bg-clip-text bg-gradient-brand">businesses</span> that power the world.
          </h1>
          
          <p className="mt-8 text-xl text-ink/60 max-w-xl font-light leading-relaxed">
            We exist to make modern technology behave like it was designed for the way real businesses actually run. We are engineers, strategists, and operational experts.
          </p>
        </Reveal>
          ...
          <div className="relative w-full aspect-square max-w-md mx-auto">
             ...
             <div className="relative h-full w-full rounded-[2rem] border border-white/60 bg-white/40 backdrop-blur-2xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] p-8 overflow-hidden flex flex-col justify-between">
                ...
                <div className="relative z-10">
                   ...
                   <h3 className="font-display text-3xl font-bold text-ink mb-4">Precision over buzzwords.</h3>
                   <p className="text-ink/70 text-lg leading-relaxed">
                     While others chase trends, we focus on deterministic outcomes. We map value flows, then architect systems to amplify them.
                   </p>
                </div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 grid lg:grid-cols-12 gap-16 items-center">
        <Reveal className="lg:col-span-5 relative">
           ...
           <h2 className="font-display font-extrabold text-4xl lg:text-5xl text-ink leading-tight">
             A consulting firm with the discipline of an <span className="italic text-brand-2">engineering team.</span>
           </h2>
        </Reveal>
        <Reveal className="lg:col-span-7" delay={100}>
           <div className="space-y-8 text-lg text-ink/70 leading-relaxed max-w-2xl">
             <p>
               RAPTRON Digital Solutions LLC is a premium technology partner specializing in ERP, business
               process re-engineering, AI consulting, and custom software. We work with leadership teams
               that want a partner who is opinionated, vendor-neutral, and accountable for outcomes — not
               just deliverables.
             </p>
             <p>
               Our work begins where most consulting ends: with the operational reality. We don't believe in
               abstract strategy decks. We believe in shipping robust, scalable systems that directly impact
               the bottom line.
             </p>
        ...
        <Reveal>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="rounded-[2.5rem] bg-white border border-hairline p-12 lg:p-16 shadow-sm hover:shadow-card transition-shadow duration-500 relative overflow-hidden group">
              ...
              <div className="relative z-10">
                <div className="font-mono text-[13px] uppercase tracking-[0.2em] text-brand font-semibold mb-6">Our Mission</div>
            ...
            <div className="rounded-[2.5rem] bg-ink text-white p-12 lg:p-16 shadow-card relative overflow-hidden group hover:shadow-glow transition-all duration-500">
              ...
              <div className="relative z-10">
                <div className="font-mono text-[13px] uppercase tracking-[0.2em] text-brand-2 font-semibold mb-6">Our Vision</div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <Reveal>
          <div className="text-center mb-20 max-w-3xl mx-auto">
            <div className="font-mono text-[11px] uppercase tracking-[0.2em] text-brand mb-4">Core Values</div>
            <h2 className="font-display font-extrabold text-5xl lg:text-6xl tracking-tight text-ink">The things we won't compromise on.</h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {VALUES.map((v, i) => {
              ...
              return (
                <div key={v.title} className="group relative rounded-[2rem] border border-hairline bg-surface-tinted p-8 overflow-hidden hover:shadow-card transition-all duration-500 hover:-translate-y-2">
...
function Counter({ value, suffix, label, delay }: { value: number; suffix: string; label: string; delay: number }) {
  ...
  return (
    <div ref={ref}>
      ...
      <div className="mt-3 text-sm lg:text-base font-mono uppercase tracking-widest text-white/50">{label}</div>
    </div>
   );
}
